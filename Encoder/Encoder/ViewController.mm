...
- (void)viewDidLoad {
    [super viewDidLoad];
    Byte *cColors = (Byte *)malloc(3 * Canvas_Row * Canvas_Col * sizeof(Byte));
    Byte *bY = (Byte *)malloc(Canvas_Row * Canvas_Col * sizeof(Byte));
    Byte *bCb = (Byte *)malloc(Canvas_Row * Canvas_Col * sizeof(Byte));
    Byte *bCr = (Byte *)malloc(Canvas_Row * Canvas_Col * sizeof(Byte));
...
- (void)DCT:(Byte *)block {
    Byte *bTemp = (Byte *)malloc(8 * 8 * sizeof(Byte));
    for (int i = 0; i < 64; i++)
        bTemp[i] = (block[i] -128);
...
- (void)zigZag:(Byte *)block andQuantization:(int)Tqi {
    ...
    for (int i = 0; i < 64; i++)
        block[i] = bTemp[iZigZagArray[i]] / iQuantizationTables[Tqi][i];
